    ...
    <div class="main">
        ...
        <div id="center" class="igram">
            <form name="Obrazec" id="obrazec" method="post" autocomplete="off" action="<?php if($_SESSION["stevVrz"]==$_SESSION["stevMet"]){echo 'konec.php';}else{echo 'igra.php';}?>">
                ...
                <div class=dol>
                    <div></div>
                Izvedeni meti: <?php echo  $_SESSION["stevVrz"]  ?>
                </div>
                        <input class="baton1" type="submit" id="gumb" value="<?php if($_SESSION["stevVrz"]==$_SESSION["stevMet"]){echo 'Results';}else {echo 'Throw';}  ?>">
                    </br>
                </div>
            </form>
        </div>
